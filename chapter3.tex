...
\nocite{papoulis:probabilityrandomvariablesandstochasticprocesses:2001}
\nocite{cooley:moc-19:1965}
\nocite{ogata:moderncontrolengineering:2002}
\nocite{gleb:appliedoptimalestimation:1974}
\nocite{anderson:optimalfiltering:1979}
\nocite{stengel:optimalcontrolandestimation:1994}
\nocite{haykin:adaptivefiltertheory:2002}
\nocite{stewart:ieee-ccvpr:1999}
\nocite{kalman:asme-t-jobe-82d:1960}
\nocite{welch:siggraph:2001}
\nocite{dellaert:spie-its:1997}
\nocite{fischler:cacm-24-6:1981}
\nocite{matsumoto:acm-tomcs-8-1:1998}
\nocite{huber:taos-13-2:1985}
\nocite{valiant:cacm-27-11:1984}
\nocite{rasmussen:gaussianprocessesformachinelearning:2005}
\nocite{doucet:sequentialmontecarloinpractice:2001}
